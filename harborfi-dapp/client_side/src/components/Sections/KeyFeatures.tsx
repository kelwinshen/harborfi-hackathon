...
const KeyFeatures = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Easily convert between regional stablecoins (HIDR, HTHB, HVND).",
    },
    {
      title: "QR-Based Payments",
      description:
  ...
  return (
    <>
      <section className="w-full py-[80px] xl:py-[150px] mt-[0px] xl:mt-[300px] mx-auto px-4 container">
      ...
      <section className="w-full py-[150px] mx-auto container px-4">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex justify-center items-center gap-12 xl:gap-24">
            <div className="flex flex-col items-center">
              ...
              <p className="xl:text-4xl font-bold mt-2">(0.05%)</p>
            </div>
