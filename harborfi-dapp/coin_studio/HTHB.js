...
//0x9343850dBdD5AAfac57084f6Be7777c736815DF5
// ===== SETTINGS =====
...
const abi = fs.readFileSync("./contracts/artifacts/HTHBToken.abi").toString();
const bytecode = fs.readFileSync("./contracts/artifacts/HTHBToken.bin").toString();
