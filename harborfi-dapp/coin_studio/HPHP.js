...
//0x8242b1F5B6A067d1EADf3AD5093636188bDfcBC6
// ===== SETTINGS =====
...
const abi = fs.readFileSync("./contracts/artifacts/HPHPToken.abi").toString();
const bytecode = fs.readFileSync("./contracts/artifacts/HPHPToken.bin").toString();
